...
const SCENE_PROMPT =
  ...
  "The OUTPUT MUST BE IN FULL NATURAL COLOR — never leave it black-and-white, grayscale or sepia. If the photo sits inside a printed page with a caption, crop out the surrounding paper and caption text so only the photograph itself remains. " +
