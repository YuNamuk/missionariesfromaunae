            ...
            <div style={{ padding: "16px 20px 24px", overflowY: "auto" }}>
              ...
              <section style={{ marginBottom: 14 }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginBottom: selPerson.sources.length > 0 ? 8 : 0 }}>
                  ...
                  <a href={`https://namu.wiki/w/${encodeURIComponent(selPerson.name)}`} target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 4, padding: "6px 11px", borderRadius: 99, border: `1px solid ${C.line}`, background: "#fff8ec", color: "#3a7d44", fontSize: 12, fontWeight: 800, textDecoration: "none" }}>나무위키 ↗</a>
                  {selPerson.en && (
                    <a href={`https://en.wikipedia.org/wiki/Special:Search?search=${encodeURIComponent(selPerson.en)}`} target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 4, padding: "6px 11px", borderRadius: 99, border: `1px solid ${C.line}`, background: "#fff8ec", color: "#5f4d39", fontSize: 12, fontWeight: 800, textDecoration: "none" }}>Wikipedia ↗</a>
                  )}
                </div>
