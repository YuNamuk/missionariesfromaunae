...
export const COLORIZED: ReadonlySet<string> = new Set([
  "allen", "annie", "anniebaird", "appenzeller", "avison", "baird", "davis", "eugenebell", "fenwick", "gale", "gilseonju", "hardie", "heron", "hulbert", "jones", "junkin", "kimchangsik", "leegipung", "leesujeong", "lillias", "maclay", "mckenzie", "moffett", "mscranton", "reynolds", "rosetta", "ross", "schofield", "seo", "seogyeongjo", "shepping", "switzer", "trollope", "underwood", "william", "wjhall",
]);
